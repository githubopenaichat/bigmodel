from transformers import AutoConfig, AutoModelForCausalLM, AutoTokenizer,AdamW,get_scheduler
...
token = "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"
login(token)
...
dataset_name,project_name = "codeparrot"
# Logging
